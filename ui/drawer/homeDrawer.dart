  ...
  void setdDrawerListArray() {
    drawerList = [
      ...
      DrawerList(
        ...
        labelName: 'Lista Producto',
        isAssetsImage: true,
        imageName: "assets/images/library-icon.png",
      ),
      DrawerList(
        index: DrawerIndex.FeedBack,
        labelName: 'Lista Almacen',
        icon: new Icon(Icons.help),
      ),
      DrawerList(
        index: DrawerIndex.Invite,
        labelName: 'Lista Entrada',
        icon: new Icon(Icons.group),
      ),
      DrawerList(
        index: DrawerIndex.Share,
        labelName: 'Lista Detalle Produccion',
        icon: new Icon(Icons.amp_stories),
      ),
      DrawerList(
        index: DrawerIndex.Testing,
        labelName: 'Lista Detalle Salida',
